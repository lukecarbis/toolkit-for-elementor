...
class Toolkit_Minify_CSS_UriRewriter {
     ...
     *      $url = Toolkit_Minify_CSS_UriRewriter::parse($elem->getAttribute('href');
     *      if ($url->is_url()) {
     ...
     * <ul>
     *   <li>write(Toolkit_Minify_CSS_UriRewriter::WRITE_FLAG_OMIT_SCHEME) returns protocol-relative url</li>
     *   <li>write(Toolkit_Minify_CSS_UriRewriter::WRITE_FLAG_OMIT_SCHEME | Toolkit_Minify_CSS_UriRewriter::WRITE_FLAG_OMIT_HOST) returns host-relative url</li>
     * </ul>
     *
     ...
     * @return Toolkit_Minify_CSS_UriRewriter $this
     */
     ...
     *
     * @param Toolkit_Minify_CSS_UriRewriter|string|null $baseurl
     * @return Toolkit_Minify_CSS_UriRewriter $this
     */
    public function makeAbsolute($baseurl = null) {
        if (!$baseurl) return $this;
        if (!$baseurl instanceof Toolkit_Minify_CSS_UriRewriter) $baseurl = new static($baseurl);
        if ($this->is_url() && ($this->is_relative() || $this->is_host_relative() || $this->is_protocol_relative()) && $baseurl instanceof Toolkit_Minify_CSS_UriRewriter) {
    ...
    /**
     * @param Toolkit_Minify_CSS_UriRewriter|string $another_url
     * @return bool
     */
    public function equals($another_url)
    {
        if (!($another_url instanceof Toolkit_Minify_CSS_UriRewriter)) $another_url = new static($another_url);
    ...
    /**
     * @param string|array|Toolkit_Minify_CSS_UriRewriter $another_query
     * @return bool
     */
    public function equalsQuery($another_query)
    {
        ...
        elseif ($another_query instanceof Toolkit_Minify_CSS_UriRewriter) $another_query_array = $another_query->getQueryArray();
    ...
    /**
     * @param string $url
     * @return Toolkit_Minify_CSS_UriRewriter
     */
